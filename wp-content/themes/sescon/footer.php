    ...
    <footer class="footer">
        ...
        <div class="footer-mobile">
            <h3 class="btn-open-footer">
                Mais Informações
            </h3>
            <a href="#" class="logo-footer logo-footer-mobile">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo-footer-sescon-sp.png" alt="">
            </a>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#slide-home').slick({
                ...
                slidesToShow: 1,
                slidesToScroll: 1,
                appendDots:'#dots-slide-home'
            });

            $('#slide-home-mobile').slick({
                dots: true,
                arrows: false,
                infinite: false,
                speed: 300,
